...
$usn=$_SESSION['usn'];
$query="SELECT assignment_name, assignment_subject, date_assigned, due_date FROM assignment where sem=(select student_sem from students where student_usn='$usn') and department=(select student_department from students where student_usn='$usn') and assignment_id not in(select assignment_id from submitted where student_usn='$usn')";
          ...
          <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                    ...
                    if($rows==0){
                        	$cong="Just Chill..! You Have No Pending Assignments";
